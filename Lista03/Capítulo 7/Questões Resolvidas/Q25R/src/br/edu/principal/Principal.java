...
public class Principal {
	...
	public static void main(String[] args) {
        ...
        int[][] bim = new int[5][3];
        int tot_prod, tot_loja, maior = 0;

       
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 3; j++) {
                System.out.print("Digite o valor para mes1[" + (i + 1) + "][" + (j + 1) + "]: ");
                mes1[i][j] = sc.nextInt();
            }
        }
        ...
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 3; j++) {
                System.out.print("Digite o valor para mes2[" + (i + 1) + "][" + (j + 1) + "]: ");
                mes2[i][j] = sc.nextInt();
            }
        }
        ...
        System.out.println("Maior valor do bimestre: " + maior);
